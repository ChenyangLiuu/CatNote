...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnItemLongClickListener {
    ...
    private List<com.example.catnote.Note> noteList = new ArrayList<com.example.catnote.Note>();
            ...
            public void run() {
                ...
                lv_tag.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        List<String> tagList = Arrays.asList(sharedPreferences.getString("tagListString", null).split("_")); //获取tags
                        int tag = position + 1;
                        List<com.example.catnote.Note> temp = new ArrayList<>();
                        for (int i = 0; i < noteList.size(); i++) {
                            if (noteList.get(i).getTag() == tag) {
                                com.example.catnote.Note note = noteList.get(i);
                                temp.add(note);
                            }
                        }
                                            ...
                                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    ...
                                                    for (int i = 0; i < noteList.size(); i++) {
                                                        ...
                                                        com.example.catnote.Note temp = noteList.get(i);
                                                        if (temp.getTag() == tag) {
                                                            temp.setTag(1);
                ...
                setting_text.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(com.example.catnote.MainActivity.this, com.example.catnote.UserSettingsActivity.class));
    ...
    protected void needRefresh() {
        setNightMode();
        Intent intent = new Intent(this, com.example.catnote.MainActivity.class);
    ...
    public void initView() {
        ...
        fab.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.catnote.MainActivity.this, com.example.catnote.EditActivity.class);
        ...
        fab_alarm.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.catnote.MainActivity.this, EditAlarmActivity.class);
    ...
    public void initPopupView() {
        ...
        layoutInflater = (LayoutInflater) com.example.catnote.MainActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                if (view != null) {
                    view.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(com.example.catnote.MainActivity.this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            case R.id.lv:
                com.example.catnote.Note curNote = (com.example.catnote.Note) parent.getItemAtPosition(position);
                Intent intent = new Intent(com.example.catnote.MainActivity.this, com.example.catnote.EditActivity.class);
            ...
            case R.id.lv_plan:
                ...
                Intent intent1 = new Intent(com.example.catnote.MainActivity.this, EditAlarmActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (returnMode == 1) {  //update current note
            ...
            com.example.catnote.Note newNote = new com.example.catnote.Note(content, time, tag);
            ...
            com.example.catnote.Note curNote = new com.example.catnote.Note();
    ...
    //按模式时间排序笔记
    public void sortNotes(List<com.example.catnote.Note> noteList, final int mode) {
        Collections.sort(noteList, new Comparator<com.example.catnote.Note>() {
            @Override
            public int compare(com.example.catnote.Note o1, com.example.catnote.Note o2) {
                try {
                    if (mode == 1) {
    ...
    private void startAlarm(Plan p) {
        ...
        if(!c.before(Calendar.getInstance())) {
            Intent intent = new Intent(com.example.catnote.MainActivity.this, AlarmReceiver.class);
    ...
    public class Achievement {
        ...
        //加入已写好的笔记
        private void addCurrent(List<com.example.catnote.Note> list) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
