...
public class UserSettingsActivity extends BaseActivity {
    ...
    private void initView(){
        ...
        fabColor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.catnote.UserSettingsActivity.this, FabColorActivity.class);
    ...
    private void setSelfNightMode(){
        ...
        super.setNightMode();
        Intent intent = new Intent(this, com.example.catnote.UserSettingsActivity.class);
        intent.putExtra("night_change", !night_change); //重启一次，正负颠倒。最终为正值时重启MainActivity。

        startActivity(new Intent(this, com.example.catnote.UserSettingsActivity.class));
